...
#ifndef TECHDRAW_FUSIONNAVSTYLE_H
#define TECHDRAW_FUSIONNAVSTYLE_H
...
class TechDrawGuiExport QGVNavStyleFusion : public QGVNavStyle
{
public:
    explicit QGVNavStyleFusion(QGVPage* qgvp);
    ~QGVNavStyleFusion() override;
...
#endif // TECHDRAW_FUSIONNAVSTYLE_H
